...
class SearchDistrict extends SearchDelegate{
  ...
  final suggestionlist = query.isEmpty ? listofCityData :
    listofCityData.where((element) =>
        element.district.toString().toLowerCase().contains(query)).toList();
        return Scaffold(
          ...
          body: ListView.builder(
            ...
            itemBuilder: (context,index){
              return GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) =>DistrictScreen(distdata: suggestionlist,dname: suggestionlist[index].district,)));
                },
                child: Card(
            ...
            child: Row(
              ...
              children: <Widget>[
               ...
               FadeAnimation(1.2,Text(
                suggestionlist[index].confirmed.replaceAllMapped(kreg, kmathFunc),
                 style: TextStyle(
           fontWeight: FontWeight.bold,
           fontSize: 18.0,
           fontFamily: 'SourceSansPro',
